...
public class Test_Positions_2 
{
	public static void main(String[] args)
	{
		...
		//set the white rook
		game.getChessBoard()[7][6] = game.wQRook;
		
		//set the white bishop
		game.getChessBoard()[4][3] = game.wQBishop;
		//game.getChessBoard()[3][4] = game.wQBishop;
		
		//set the white knight
		game.getChessBoard()[1][4] = game.wQKnight;
		
		//set the black king 
		game.getChessBoard()[7][0] = game.bKing;
		game.setBlackKingPosition(7, 0);
		
		//set the black pawn h 
		//game.getChessBoard()[6][7] = game.bpawn8;
